-- Read-only deployment check for the single-vessel frozen card summary query.
-- Run separately AFTER 20260923170000_itinerary_vessel_history_summary.sql.
...
with target as (
 ...
 union all select 'exact-function-body',coalesce(md5(regexp_replace(prosrc,'\s','','g'))='d44f2f1a320af12058c6216839648434',false) from target
