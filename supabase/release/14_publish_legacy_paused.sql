...
BEGIN
 ...
 SELECT request_id,result INTO STRICT sid,proof FROM ship_dynamics_quiescence_private.stages_v1 WHERE workspace_key=w AND transition_id=q.transition_id;
 SET LOCAL ROLE service_role;
 r:=public.publish_ship_dynamics_source_authority_v2(w,wid,q.transition_id,sid,proof,'legacy',op);
