...
export default function App() {
  ...
  const closedTasks = useMemo(() => data.tasks.filter(t=>t.isClosed&&taskMatchesFilters(t,closedFilters,vesselMap,currentUser,false,canViewAllVessels)),[data.tasks,vesselMap,currentUser,closedFilters,canViewAllVessels]);
