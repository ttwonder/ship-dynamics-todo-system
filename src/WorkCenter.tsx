...
type Props={data:AppData;user:UserAccount;vessels:Vessel[];onOpenTask:(task:TaskItem)=>void;onOpenVessel:(vesselId:string)=>void;markAllRead:()=>void;canComplete:boolean;canDelete:boolean;canPrint:boolean;onPrint:()=>void;onBatchComplete:(ids:string[])=>boolean;onBatchDelete:(ids:string[])=>boolean};

export default function WorkCenter({data,user,vessels,onOpenTask,onOpenVessel,markAllRead,canComplete,canDelete,canPrint,onPrint,onBatchComplete,onBatchDelete}:Props){
