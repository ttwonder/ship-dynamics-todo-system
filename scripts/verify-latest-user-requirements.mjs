...
try {
  ...
  assert.ok(management.includes('Owner／管理員登入必須使用密碼') && management.includes('canClearPassword') && management.includes('不可清除 Owner／管理員密碼') && management.includes('clearPersonPassword') && !management.includes('Owner 可查看'), 'Owner 只能重設密碼；清除密碼僅適用非管理人員，且不得查看既有明文');
