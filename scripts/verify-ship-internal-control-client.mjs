...
try{
 ...
 const draft=form.createInternalControlBatchDraft('v1','維修');Object.assign(draft.rows[0],{description:'只新增內控',status:'待協助',departments:['管理組'],syncToTask:true,closedDate:'2026-09-19'});
 ...
 console.log('PASS ship internal-control client: closed payload, exact ACK, lost ACK, immutable retry, stale config, durable scoped draft, quota fail-closed');
