...
try {
  ...
  Object.assign(doc.rows[0], { voyageNumber: 'V001', portDockName: 'ULSAN', operation: 'Loading', etaUtc: '2026-09-01T00:00:00Z', etdUtc: '2026-09-03T00:00:00Z', portTimeZone: 'Asia/Seoul' });
  const range = calendar.calendarRangeFromLocalDate('2026-09-01', 7, 'Asia/Taipei');
  ...
  assert.equal(calendar.calendarRangeFromLocalDate('2026-09-01', 7, 'UTC+8').ok, false);
